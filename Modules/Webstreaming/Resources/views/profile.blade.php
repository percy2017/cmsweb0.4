            ...
            <div class="row">
                <div class="col-lg-7 col-md-10">
                 ...
                 {{--    @if(session('greetings_histream'))
                    ...
                    @endphp --}}
                    <a href="{{ route('voyager.dashboard') }}" class="btn btn-neutral">Ir a Panel de Control</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card bg-gradient-info border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    ...
                                    <a
                                        href="https://play.google.com/store/apps/details?id=com.loginweb.histream&hl=es_419"><span
                                            class="text-nowrap text-light"> Dale click aquí</span></a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Tú plan es : <a href="" class="btn btn-sm btn-primary">Gratis</a></h3>
                            </div>
