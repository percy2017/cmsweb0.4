                                ...
                                <tr id="{{ $data->id }}">
                                    ...
                                    <td>
                                        ...
                                        **********
                                        ...
                                        @if($loop->first)
                                        <a href="javascript:;"
                                            onclick="ajax_first('{{ $data->id }}', '{{ $dataType->slug }}')">
                                    ...
                                    <td class="no-sort no-click bread-actions">
                                        <a href="#"
                                            onclick="ajax('{{ route('inti_recovery', [$dataType->name, $data->id]) }}', 'recovery')"
                                            title="Eliminar" class="btn btn-success">
                                            <i class="voyager-upload"></i> <span
                                                class="hidden-xs hidden-sm">Recuperar</span>
                                        </a>
                                    </td>
                                </tr>
                                @endforeach
