...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="{{ asset('vendor/bimgo/css/bootstrap.min.css') }}" rel="stylesheet">
  <!-- Material Design Bootstrap -->
  <link href="{{ asset('vendor/bimgo/css/mdb.min.css') }}" rel="stylesheet">
...
<body class="homepage-v2 hidden-sn white-skin animated">
  ...
  <!-- SCRIPTS -->
  <!-- JQuery -->
  <script type="text/javascript" src="{{ asset('vendor/bimgo/js/jquery-3.4.1.min.js') }}"></script>
  <!-- Bootstrap tooltips -->
  <script type="text/javascript" src="{{ asset('vendor/bimgo/js/popper.min.js') }}"></script>
  <!-- Bootstrap core JavaScript -->
  <script type="text/javascript" src="{{ asset('vendor/bimgo/js/bootstrap.min.js') }}"></script>
  <!-- MDB core JavaScript -->
  <script type="text/javascript" src="{{ asset('vendor/bimgo/js/mdb.min.js') }}"></script>
