            ...
            --}}
              ...
              <div class="card card-ecommerce">
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer pb-0">
                        <div class="row mb-0">
                            @if($products->price_last > 0)
                                <h5 class="mb-0 pb-0 mt-1 font-weight-bold"><span
                                    class="red-text"><strong>{{ $products->price }} Bs.</strong></span>
                                    <span class="grey-text"><small><s>{{ $products->price_last }} Bs.</s></small></span>
                                </h5>
                            @else 
                                <span class="float-left"><strong>{{ $products->price }} Bs.</strong></span>
                            @endif
                            <span class="float-right">
