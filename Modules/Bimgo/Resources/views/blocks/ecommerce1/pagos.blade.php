<div class="container my-5">
  ...
  <section class="dark-grey-text text-center">
    ...
    <h3 class="font-weight-bold mb-4 pb-2">Metodos de Pagos</h3>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-12 mb-4">
        ...
        <div class="px-3 pt-3 mx-1 mt-1 pb-0">
          <h4 class="font-weight-bold mt-1 mb-3">Tigo Money</h4>
          ...
          <a href="{{ url('gracias') }}" class="btn btn-indigo btn-sm btn-rounded"><i class="fas fa-clone left"></i> View project</a>
        </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="px-3 pt-3 mx-1 mt-1 pb-0">
          <h4 class="font-weight-bold mt-1 mb-3">BNB</h4>
          <p class="text-muted">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae.</p>
          <a href="{{ url('gracias') }}" class="btn btn-indigo btn-sm btn-rounded"><i class="fas fa-clone left"></i> View project</a>
        </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        ...
        <div class="px-3 pt-3 mx-1 mt-1 pb-0">
          <h4 class="font-weight-bold mt-1 mb-3">UNINET</h4>
          <p class="text-muted">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae.</p>
          <a href="{{ url('gracias') }}" class="btn btn-indigo btn-sm btn-rounded"><i class="fas fa-clone left"></i> View project</a>
        </div>
