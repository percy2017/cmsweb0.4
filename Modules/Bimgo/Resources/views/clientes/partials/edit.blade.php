<div id="modalEditClientes" class="modal fade" data-backdrop="static">
		...
		<div class="modal-content">
			...
			<form id="frmClienteA">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-sm  btn-primary" id="btnActualizar" data-dismiss="modal"><i class="voyager-edit"></i> {{ __('voyager::generic.save') }}</button>
